...
//
//     final coinRichModel = coinRichModelFromJson(jsonString);

import 'dart:convert';

CoinRichModel coinRichModelFromJson(String str) =>
    CoinRichModel.fromJson(json.decode(str));

String coinRichModelToJson(CoinRichModel data) => json.encode(data.toJson());
...
class CoinRichModel {
  ...
  factory CoinRichModel.fromJson(Map<String, dynamic> json) => CoinRichModel(
